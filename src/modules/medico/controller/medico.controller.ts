...
export class MedicoController {
  ...
  async getMedicos(paginationParams?: PaginationParams): Promise<PaginatedApiResponse<Medico>> {
    try {
      const medicos = await this.medicoService.getMedicos(paginationParams);
